# Business Model: Independent Public-Sector Market-Entry & Procurement Compliance Service — Namibia

## Classification

- Repository: `cloud-itonami-iso3166-nam`
- ISO 3166: `NAM` (Namibia)
...
- Social impact: [:namibian-sme-market-access :public-spend-transparency :cross-border-friction-reduction]

## Customer

- an already-incorporated `cloud-itonami-cofog-{code}` /
  `cloud-itonami-isco-{code}` / `cloud-itonami-unspsc-{segment}` /
  `cloud-itonami-{ISIC}` operator wanting to bid on a Namibian
  public contract
...
- registration walkthrough for the government's e-procurement portal
  (eprocurement.gov.na), overseen by the Central Procurement Board of
  Namibia (CPBN), which manages tender publication for all government
  ministries and agencies
- business/tax registration checklist: an entry with BIPA (Business and
  Intellectual Property Authority, established under the BIPA Act 2016),
  Namibia's one-stop center for business and IP registration
- local-content / preferential-procurement navigation: Namibian
...
- this service does **not** provide legal or tax advice; characterization
  ...
  routes to Namibian-licensed counsel or a registered agent
...
- **`cloud-itonami-cofog-{code}`**: a jurisdiction-agnostic operator
  ...
  blueprint AND this one to operate in Namibia).
