(ns marketentry.store
  "SSoT for the Namibia (NAM) market-entry compliance actor, behind a
...
(defn demo-data
  ...
  `:seeking-board-routing-determination?` / `:pe-category` /
  `:contract-type` / `:estimated-value` / `:claimed-board-routing?` are
  ground truth for the flagship check (CPBN's own Public Procurement
  Regulations Annexure 1 category/contract-type threshold matrix).
  `eng-4`'s buyer category (Category 2) is not arbitrary -- Annexure 1
  itself lists the Business and Intellectual Property Authority (BIPA)
  as a Category 2 public entity, the same authority this catalog cites
  for company registration."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Windhoek Fabrication (Pty) Ltd" :portal "bipa.na"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :seeking-board-routing-determination? false :pe-category nil :contract-type nil
             :estimated-value nil :claimed-board-routing? nil
             :drafted? false :submitted? false
             :jurisdiction "NAM" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "bipa.na"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :seeking-board-routing-determination? false :pe-category nil :contract-type nil
             :estimated-value nil :claimed-board-routing? nil
    ...
    "eng-3" {:id "eng-3" :operator "Erongo Logistics Namibia (Pty) Ltd" :portal "bipa.na"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "NAM" :status :intake}
    "eng-4" {:id "eng-4" :operator "Karas Civil Works (Pty) Ltd" :portal "bipa.na"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :seeking-board-routing-determination? true :pe-category :category-2 :contract-type :goods
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               seeking-board-routing-determination? pe-category contract-type estimated-value claimed-board-routing?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? seeking-board-routing-determination?) (assoc :engagement/seeking-board-routing-determination? seeking-board-routing-determination?)
    pe-category                           (assoc :engagement/pe-category pe-category)
    ...
    (some? claimed-board-routing?)        (assoc :engagement/claimed-board-routing? claimed-board-routing?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/seeking-board-routing-determination? :engagement/pe-category :engagement/contract-type
   :engagement/estimated-value :engagement/claimed-board-routing?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :seeking-board-routing-determination? (boolean (:engagement/seeking-board-routing-determination? m))
     :pe-category (:engagement/pe-category m)
     :contract-type (:engagement/contract-type m)
     :estimated-value (:engagement/estimated-value m)
     :claimed-board-routing? (boolean (:engagement/claimed-board-routing? m))
